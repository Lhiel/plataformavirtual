        ...
        <div class="card-body bg-gray-100">
            ...
            <div x-show = "open">
                ...
                <div class="flex justify-between items-center">
                    <p><i wire:click = "download" class="fas fa-download text-green-500 mr-2 cursor-pointer"></i>{{$lesson->resource->url}}</p>
                ...
                <form wire:submit.prevent = "save">
                    <div class="flex items-center">
                        <div class="border-4 flex-1">
                            <input wire:model = "file" type="file" class="form-input flex-1 text-sm">
                        </div>
