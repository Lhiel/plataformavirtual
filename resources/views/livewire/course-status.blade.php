<div class="mt-8">
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8 ">
            ...
            @endif
                    <div class="flex justify-between mt-4">
                        <div class="flex items-center  cursor-pointer" wire:click="completed">
                            ...
                            @else
                                <i class="fas fa-toggle-off text-2xl text-gray-500 "></i>
                            @endif
                            <p class="text-sm ml-2">Marcar esta unidad como culminada</p>
                        </div>
                        @if ($current->resource)
                            <div class="flex items-center text-gray-600">
                                <i class="fas fa-down   load text-lg"></i>
                                <p class=" text-sm ml-2 cursor-pointer" wire:click = "download">Descargar recursos</p>
                            </div>
                        @endif
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h1 class="txext-xl leading-8 text-center mb-4 ">{{$course->title}}</h1>
                ...
                <div class="relative pt-1">
                    <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200">
                      <div style="width:{{$this->advance.'%'}}" class="shadow-none flex flex-col text-center 
                        whitespace-nowrap text-white justify-center bg-blue-500 transition-all duration-500"></div>
                    </div>
                  </div>
